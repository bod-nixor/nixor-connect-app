...
import {
    createChannel as createPanapticonChannel,
    getServerBySpaceId,
    isPanapticonEnabled,
...
export const showCreateNewRoom = async (space: Room, type?: RoomType): Promise<boolean> => {
    ...
    if (isPanapticonEnabled()) {
        ...
        const channel = await createPanapticonChannel(server.public_id, {
    ...
    // Local/dev fallback when Panapticon API is disabled.
    opts.createOpts = {
        ...(opts.createOpts ?? {}),
        creation_content: {
