...
Nixor Connect is Nixor College's Matrix web and desktop client, based on the Element Web/Desktop monorepo. This fork adds Nixor branding and Panapticon-backed permissions for managed servers, channels, and roles.

The upstream Element documentation is retained below for build, development, and licensing context.
